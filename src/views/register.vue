    ...
    <div class='login signup-form'>
      ...
      <div class='login_fields'>
          <div class='login_fields__user'>
              ...
              <input placeholder='Full Name' maxlength="20" type='text' v-model="form.name" required>
          ...
          <div class='login_fields__user'>
              ...
              <input placeholder='Username' maxlength="20" type='text' v-model="form.Uname" required>
              <div class='validation'>
                  <img src='../assets/images/tick.png'>
              </div>
              </input>
          ...
          <div class='login_fields__user'>
              ...
              <input placeholder='Email Address' maxlength="100" type='text' v-model="form.email" id="txtEmail" required>
              <div class='validation'>
                  <img src='../assets/images/tick.png'>
              </div>
              </input>
          ...
          <div class='login_fields__password'>
              ...
              <input placeholder='Password' maxlength="20" type='password' v-model="form.pass" required>
              <div class='validation'>
                  <img src='../assets/images/tick.png'>
              </div>
          </div>
          <div class='login_fields__password'>
              ...
              <input placeholder='Confirm Password' maxlength="20" class="input-fields" type='password' v-model="form.checkPass" required>
              <div class='validation'>
                  <img src='../assets/images/tick.png'>
              </div>
          </div>

...
let cssUrls = [{
            ...
            'Base Components': '<link id="base-component-css" rel="stylesheet" href="https://res.cloudinary.com/flowz/raw/upload/v1521612936/builder/css/component-base.css" type="text/css">'
            }];

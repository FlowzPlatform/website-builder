...
export default {
  ...
  mounted () {
		...
		editor = grapesjs.init({
			plugins: ['gjs-plugin-forms', 'gjs-plugin-export', 'gjs-preset-webpage', 'gjs-aviary', 'product-plugin'],
      		container : '#gjs',

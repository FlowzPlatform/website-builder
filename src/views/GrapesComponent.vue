...
export default {
   ...
   //    		});
    ...
    getHtml: function () {
          ...
          // while ((temp = regex.exec(uglyCss)) != null) {  
          //   resultArray.push(temp[1]);
          // }

          // if(resultArray.length > 0){
          //   // Remove the last occurence
          //   var findedString = resultArray[resultArray.length - 1];
          //   var re = new RegExp(findedString, 'g');
          //   uglyCss = uglyCss.replace(re, '');
          // } else {
          //   // Do nothing
          // }

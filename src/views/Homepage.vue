                    ...
                    <div class="feature-container col-xs-12">
                        <div class="row">
                            <div class="feature col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-0 text-center">
                                ...
                                <h4>Drag 'n Drop</h4>
                                <p>Easily created webpage using 1000+ drag and drop components</p>
                            </div>
                            <!-- /.feature -->

                            <div class="feature col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-0 text-center">
                                <span class="lnr lnr-cloud-check"></span>
                                <h4>Publish to Cloud</h4>
                                <p>Publish your site directly to your domain</p>
                            </div>
                            <!-- /.feature -->

                            <div class="feature col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-0 text-center">
                                <span class="lnr lnr-cog"></span>
                                <h4>Manage Youe site</h4>
                                <p>Keep records, track and manage you website</p>
                            </div>
                            <!-- /.feature -->
                        </div>
                        <!-- /.row -->
                    ...
                    <div class="banner-child bc-left col-sm-6">
                        ...
                        <div class="animated-scroll">
                            <div class="scroll-header">
                                ...
                                <svg class="cursor" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 24 24" id="Layer_1" version="1.0" viewBox="0 0 24 24" xml:space="preserve">
          ...
          <footer>
              <div class="container">
                  ...
                  <div class="row text-center" style="margin: 2% 0;">
                      <!-- <h1 class="color-text">Flowz<span class="bold"> Builder</span></h1> -->

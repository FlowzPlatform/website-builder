  ...
  <div class="ProjectSettings">
    ...
    <div class="tab-contents">
      <div id="tab1-content" class="tab-content">
        <span class="block-title">Publish Website</span>
        <div class="card">
          <div class="row">
            <div class="col-md-12">
        ...
        <span class="block-title">Basic Settings</span>
        <div class="card">
          <div class="row">
            <div class="col-md-12">
        ...
        <span class="block-title">Roles</span>
        <div class="card">
          <div class="row">
              <div class="col-md-12">
        ...
        <span class="block-title">Revisions</span>
        <div class="card">
          <div class="row">
            <div class="col-md-12">
      ...
      <div id="tab2-content" class="tab-content">
        <span class="block-title">Import Ecommerce Website Templates</span>
        <el-tooltip class="item" effect="dark" content="Refresh All Plugins" placement="top">
          <el-button class="refresh-plugins-btn" @click.native.prevent="refreshPlugins()" :loading="refreshPluginsLoading" type="warning" icon="circle-check" :disabled="refreshDisabled"></el-button>
        </el-tooltip>
        <div class="card">
        ...
        <!-- <span class="block-title">Plugin Details</span>
        <div class="card">
          <div class="row">
        ...
        <span class="block-title">Global Variables</span>
        <div class="card">
          <div class="row">
            <div class="col-md-12" align="right" style="margin-bottom: 10px;">
      ...
      <div id="tab3-content" class="tab-content">
        ...
        <span class="block-title">Image Library</span>
        <div class="card">
          <div class="row">
            <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row" style="max-height: 705px; overflow-y: auto;" v-loading="fetchImagesLoader" element-loading-text="Loading...">
                <div class="col-md-2" v-for="(n, index) in assetsImages" style="margin-top: 15px;">
                  <div class="view-icon">
        ...
        <span class="block-title">URL Bucket</span>
        <div class="card">
          <div class="row">
            <div class="col-md-12">
              <el-form ref="form" :model="form">
        ...
        <span class="block-title">External Links</span>
        <div class="card">
          <div class="row">
            <div class="col-md-12">
                 <div class="row">
        ...
        <span class="block-title">Meta Informations</span>
        <div class="card">
          <div class="row">
            <div class="col-md-12" >
                ...
                <table class="table table-hover  table-bordered">
                  ...
                  <tbody>
                    <tr v-for="(n, index) in externallinksMeta" >
                      ...
                      <td><el-button class="pull-right" style="min-width: 100%;" type="danger" @click="deletelinkMeta(index)" icon="delete2">Delete</el-button></td>
        ...
        <span class="block-title">Global Styles and Scripts</span>
        <div class="card">
          <div class="row">
            <div class="col-md-12">
                 <div class="row">
      ...
      <div id="tab4-content" class="tab-content">
        ...
        <span class="block-title">Payment Configurations</span>
        <div class="card">
          <div class="row">
              <div class="col-md-12">
                  <div class="row">

    ...
    <div class='login'>
      ...
      <div class='login_fields'>
         <div class='login_fields__password'>
              ...
              <input placeholder='Enter Password' class="input-fields" maxlength="20" type='password' v-model="form.pass" required>
          ...
          <div class='login_fields__password'>
              ...
              <input placeholder='Enter Password Again' class="input-fields" maxlength="20" type='password' v-model="form.cpass" required>
              <div class='validation'>
                  <img src='../assets/images/tick.png'>
              </div>
          </div>
      ...
      <div class='disclaimer'>
          <p>You have requested to change your password. Enter new password. We will use this password for your next login.</p>
      </div>
    </div>
    <div class='authent'>

    ...
    methods: {
      ...
      async generatePreview() {
        ...
        setTimeout(async function() {
          ...
          if (externalCss.length > 0 && externalCss != undefined) {
          ...
          if (projectscripts.length > 0 && projectscripts != undefined) {

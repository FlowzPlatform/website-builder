    ...
    editor.TraitManager.addType('customConent1', {
        ...
        getInputEl: function() {
            if (!this.inputEl) {
                ...
                let partialOptions = {};
                console.log('traits :: ', partialOptions);
                ...
                console.log('storedTemplates1', partialOptions);
                //        });

grapesjs.plugins.add('flowz-blocks', function(editor, options) {
  ...
  bm.add('froala-callToAction-style-4', {
    label: 'Style 4',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row justify-content-center"> <div class="col-12 col-md-8 col-lg-6 text-center"> <h1>Call to Action</h1> <p class="text-h3"> Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts </p><p class="mt-5 mt-sm-4"> <a class="btn" href="#">Download</a> </p></div></div><div class="row pt-5 pb-3"> <div class="col-12 text-center"> <p><strong>Fortune 100 companies are using our products</strong></p></div></div><div class="row"> <div class="col-12 text-center"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://s3-us-west-2.amazonaws.com/airflowbucket1/flowz-builder/imgs/customers/adobe.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521385/builder/images/flowz_blocks/discovery.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2 " src="https://res.cloudinary.com/flowz/image/upload/v1521521382/builder/images/flowz_blocks/ebay.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/samsung.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/orange.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/salesforce.svg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-callToAction-style-7', {
    label: 'Style 7',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center pb-0 pb-lg-4"> <div class="col-12"> <h1>Call to action</h1> </div></div><div class="row text-center pt-4 pt-md-5"> <div class="col-12 col-sm-10 col-md-6 col-lg-4 m-sm-auto"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:18px">First Action</h3> <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p><p class="mt-3"><a class="btn" href="#">Button</a></p></div><div class="col-12 col-sm-10 col-md-6 col-lg-4 ml-sm-auto mr-sm-auto mt-5 mt-md-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:18px">Second Action</h3> <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p><p class="mt-3"><a class="btn" href="#">Button</a></p></div><div class="col-12 col-sm-10 col-md-6 col-lg-4 ml-sm-auto mr-sm-auto mt-5 mt-md-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:18px">Third Action</h3> <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p><p class="mt-3"><a class="btn" href="#">Button</a></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-callToAction-style-8', {
    label: 'Style 8',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .style-8{background-image: url(\'https://res.cloudinary.com/flowz/image/upload/v1521521356/builder/images/flowz_blocks/bg_c_1.svg\');}</style>' +
  ...
  bm.add('froala-callToAction-style-10', {
    label: 'Style 10',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .style-10{background-image: url(\'https://res.cloudinary.com/flowz/image/upload/v1521521352/builder/images/flowz_blocks/bg_1.svg\');}</style>' +
  ...
  bm.add('froala-callToAction-style-15', {
    label: 'Style 15',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row align-items-center"> <div class="col-10 col-sm-6 col-md-4 col-lg-3 m-auto m-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_4.svg"> </div><div class="col-12 col-md-8 ml-auto pt-5 pt-md-0"> <h2 style="font-size:22px">Call to action</h2> <p class="text-h3" style="font-size:16px">On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word "and" and the Little Blind Text should turn around and return to its own, safe country.</p><p class="mt-4"><a class="btn" href="#" style="font-size:18px">Take a Tour</a></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-callToAction-style-16', {
    label: 'Style 16',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .style-16{background-image: url(\'https://res.cloudinary.com/flowz/image/upload/v1521521356/builder/images/flowz_blocks/bg_c_1.svg\');}</style>' +
  ...
  bm.add('froala-callToAction-style-17', {
    label: 'Style 17',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .style-17{background-image: url(\'https://res.cloudinary.com/flowz/image/upload/v1521521353/builder/images/flowz_blocks/bg_0.svg\'); }</style>' +
      '<section class="fdb-block fdb-viewport bg-dark style-17"> <div class="container justify-content-center align-items-center d-flex"> <div class="row justify-content-center text-center"> <div class="col-12 col-md-8"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h1>Flowz Design Blocks</h1> <p class="text-h3">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p><p class="mt-5"><a href="#" class="btn">Call to Action</a></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-callToAction-style-19', {
    label: 'Style 19',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container align-items-center justify-content-center d-flex"> <div class="row align-items-center text-left"> <div class="col-12 col-sm-6"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div><div class="col-12 col-lg-5 ml-auto pt-5 pt-lg-0"> <h1>Flowz Design Blocks</h1> <p class="text-h3">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p><p class="mt-4"><a href="#" class="btn">Call to Action</a></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-callToAction-style-20', {
    label: 'Style 20',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block pb-0"> <div class="container"> <div class="row align-items-center text-left"> <div class="col-12 col-md-8"> <h1>Flowz Design Blocks</h1> <p class="text-h3">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove.</p></div><div class="col-12 col-md-3 ml-auto text-left text-md-right"> <p><a href="#" class="btn">Call to Action</a></p></div></div><div class="row pt-5"> <div class="col-12"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521352/builder/images/flowz_blocks/img_very_wide.svg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-callToAction-style-21', {
    label: 'Style 21',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .style-22{ background-image: url(\'https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/alt_wide_1.svg\'); }</style>' +
  ...
  bm.add('froala-callToAction-style-22', {
    label: 'Style 22',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row justify-content-center"> <div class="col-12 col-md-8 col-lg-5 text-center pb-md-5"> <h1>Flowz Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p><p class="mt-4"><a href="#" class="btn">Call to Action</a></p></div></div><div class="row text-center justify-content-center pt-5"> <div class="col-12 col-sm-6 col-lg-3"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:18px"><strong>Feature One</strong></h3> <p>Far far away, behind the word mountains, far from the countries</p></div><div class="col-12 col-sm-6 col-lg-3 pt-4 pt-sm-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:18px"><strong>Feature Two</strong></h3> <p>Separated they live in Bookmarksgrove right at the coast</p></div><div class="col-12 col-sm-6 col-lg-3 pt-4 pt-lg-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:18px"><strong>Feature Three</strong></h3> <p>A small river named Duden flows by their place and supplies it</p></div><div class="col-12 col-sm-6 col-lg-3 pt-4 pt-lg-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:18px"><strong>Feature Four</strong></h3> <p>Far far away, behind the word mountains, far from the countries</p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contacts-style-2', {
    label: 'Style 2',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-2{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521353/builder/images/flowz_blocks/bg_0.svg);}</style>' +
      '<section class="fdb-block bg-dark contact-style-2"> <div class="container"> <div class="row text-center justify-content-center"> <div class="col-12 col-md-8 col-lg-7"> <h1>Contact Us</h1> <h2>We love to hear from you!</h2> </div> </div> <div class="row pt-4"> <div class="col-12"> <form id="frmContact2"> <fcontact> <div class="row"> <div class="col-12 col-md"> <input type="text" name="name" class="form-control" placeholder="Name"> </div> <div class="col-12 col-md mt-4 mt-md-0"> <input type="email" name="email" class="form-control" placeholder="Email"> </div> <div class="col-12 col-md mt-4 mt-md-0"> <input type="text" class="form-control" name="phone" placeholder="Phone (optional)"> </div> </div> <div class="row mt-4"> <div class="col"> <input type="text" name="subject" class="form-control" placeholder="Subject"> </div> </div> <div class="row mt-4"> <div class="col"> <textarea class="form-control" name="message" rows="3" placeholder="How can we help?"></textarea> </div> </div> <div class="row mt-4"> <div class="col text-center"> <button type="submit" class="btn">Submit</button> </div> </div> </fcontact> </form> </div> </div> </div> </section>',
    attributes: {
  ...
  bm.add('froala-contacts-style-3', {
    label: 'Style 3',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center justify-content-center"> <div class="col-12 col-md-8 col-lg-7"> <h1>Contact Us</h1> <p class="text-h3" style="font-size:16px">One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p> </div> </div> <div class="row pt-4"> <div class="col-12 col-md-6"> <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2848.8444388087937!2d26.101253041406952!3d44.43635311654287!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40b1ff4770adb5b7%3A0x58147f39579fe6fa!2zR3J1cHVsIFN0YXR1YXIgIkPEg3J1yJthIEN1IFBhaWHIm2Ui!5e0!3m2!1sen!2sro!4v1507381157656" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe> </div> <div class="col-12 col-md-6 pt-5 pt-md-0"> <form id="frmContact3"> <fcontact> <div class="row"> <div class="col"> <input type="email" name="email" class="form-control" placeholder="Enter email"> </div> </div> <div class="row mt-4"> <div class="col"> <input type="text" name="subject" class="form-control" placeholder="Subject"> </div> </div> <div class="row mt-4"> <div class="col"> <textarea class="form-control" name="message" rows="3" placeholder="How can we help?"></textarea> </div> </div> <div class="row mt-4"> <div class="col"> <button type="submit" class="btn">Submit</button> </div> </div> </fcontact> </form> </div> </div> </div> </section>',
    attributes: {
  ...
  bm.add('froala-contacts-style-4', {
    label: 'Style 4',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-4{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521353/builder/images/flowz_blocks/bg_0.svg);}</style>' +
      '<section class="fdb-block contact-style-4"> <div class="container"> <div class="row"> <div class="col"> <div class="fdb-box fdb-touch"> <div class="row text-center justify-content-center"> <div class="col-12 col-md-9 col-lg-7"> <h1>Contact Us</h1> <p class="text-h3" style="font-size:16px">Pityful a rethoric question ran over her cheek, then she continued her way. On her way she met a copy.</p> </div> </div> <div class="row justify-content-center pt-4"> <div class="col-12 col-md-8"> <form id="frmContact4"> <fcontact> <div class="row"> <div class="col-12 col-md"> <input type="text" name="name" class="form-control" placeholder="Name"> </div> <div class="col-12 col-md mt-4 mt-md-0"> <input type="email" name="email" class="form-control" placeholder="Email"> </div> </div> <div class="row mt-4"> <div class="col"> <input type="text" name="subject" class="form-control" placeholder="Subject"> </div> </div> <div class="row mt-4"> <div class="col"> <textarea class="form-control" name="message" rows="3" placeholder="How can we help?"></textarea> </div> </div> <div class="row mt-4"> <div class="col text-center"> <button type="submit" class="btn">Submit</button> </div> </div> </fcontact> </form> </div> </div> </div> </div> </div> </div> </section>',
    attributes: {
  ...
  bm.add('froala-contacts-style-5', {
    label: 'Style 5',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block pt-0"> <div class="container-fluid p-0 pb-3"> <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2848.8444388087937!2d26.101253041406952!3d44.43635311654287!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40b1ff4770adb5b7%3A0x58147f39579fe6fa!2zR3J1cHVsIFN0YXR1YXIgIkPEg3J1yJthIEN1IFBhaWHIm2Ui!5e0!3m2!1sen!2sro!4v1507381157656" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe> </div> <div class="container"> <div class="row text-center justify-content-center pt-5"> <div class="col-12 col-md-7"> <h1>Contact Us</h1> </div> </div> <div class="row justify-content-center pt-4"> <div class="col-12 col-md-7"> <form id="frmContact5"> <fcontact> <div class="row"> <div class="col"> <input type="email" name="email" class="form-control" placeholder="Email"> </div> </div> <div class="row mt-4"> <div class="col"> <input type="text" name="subject" class="form-control" placeholder="Subject"> </div> </div> <div class="row mt-4"> <div class="col"> <textarea class="form-control" name="message" rows="3" placeholder="How can we help?"></textarea> </div> </div> <div class="row mt-4"> <div class="col text-center"> <button type="submit" class="btn">Submit</button> </div> </div> </fcontact> </form> </div> </div> <div class="row-100"></div> </div> <div class="bg-dark"> <div class="container"> <div class="row-50"></div> <div class="row justify-content-center text-center"> <div class="col-12 col-md mr-auto ml-auto"> <img alt="image" height="40" class="mb-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <p class="text-h3">+44 (112) 123 752</p> </div> <div class="col-12 col-md pt-4 pt-md-0 mr-auto ml-auto"> <img alt="image" height="40" class="mb-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <p class="text-h3" style="font-size:16px">123 6th St.<br>Melbourne, FL 32904</p> </div> <div class="col-12 col-md pt-4 pt-md-0 mr-auto ml-auto"> <img alt="image" height="40" class="mb-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <p class="text-h3" style="font-size:16px">support@website.com</p> </div> </div> <div class="row-50"></div> </div> </div> <div class="container"> <div class="row-70"></div> <div class="row text-center"> <div class="col"> <p class="text-h2"> <a href="#"><i class="fa fa-facebook" style="font-size:30px"></i></a>&nbsp;&nbsp;&nbsp; <a href="#"><i class="fa fa-twitter" style="font-size:30px"></i></a>&nbsp;&nbsp;&nbsp; <a href="#"><i class="fa fa-instagram" style="font-size:30px"></i></a>&nbsp;&nbsp;&nbsp; <a href="#"><i class="fa fa-google" style="font-size:30px"></i></a>&nbsp;&nbsp;&nbsp; <a href="#"><i class="fa fa-pinterest" style="font-size:30px"></i></a> </p> </div> </div> </div> </section>',
    attributes: {
  ...
  bm.add('froala-contacts-style-7', {
    label: 'Style 7',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block pb-0 contact-style-7"> <div class="container"> <div class="row text-center justify-content-center"> <div class="col-12 col-md-8 col-lg-7"> <h1>Contact Us</h1> <p class="text-h3" style="font-size:16px">If you’re already an active user, please <a href="#">sign in</a> before contacting us.</p> </div> </div> <div class="row-50"> </div> <div class="row justify-content-center"> <div class="col-12 col-md-8 col-lg-7"> <form id="frmContact7"> <fcontact> <div class="row"> <div class="col"> <label>Your Email Address</label> <input type="email" name="email" class="form-control"> </div> </div> <div class="row mt-4"> <div class="col"> <label>Subject (optional but helpful)</label> <input type="text" name="subject" class="form-control"> </div> </div> <div class="row mt-4"> <div class="col"> <label>How can we help?</label> <textarea class="form-control" name="message" rows="3"></textarea> </div> </div> <div class="row mt-4"> <div class="col text-right"> <button type="submit" class="btn">Submit</button> </div> </div> </fcontact> </form> </div> </div> <div class="row-100"></div> </div> <div class="container-fluid p-0"> <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2848.8444388087937!2d26.101253041406952!3d44.43635311654287!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40b1ff4770adb5b7%3A0x58147f39579fe6fa!2zR3J1cHVsIFN0YXR1YXIgIkPEg3J1yJthIEN1IFBhaWHIm2Ui!5e0!3m2!1sen!2sro!4v1507381157656" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe> </div> </section>',
    attributes: {
  ...
  bm.add('froala-contacts-style-8', {
    label: 'Style 8',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block pt-0"> <div class="bg-gray"> <div class="container"> <div class="row-100"></div> <div class="row text-left"> <div class="col-8"> <h1>Contact Us</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p> </div> </div> <div class="row-100"></div> </div> </div> <div class="container"> <div class="row-100"></div> <div class="row"> <div class="col-12 col-md-6 col-lg-5"> <h2>Call or email</h2> <p class="text-large">Support, Sales, and Account Management services are currently available in English</p> <p class="text-h3 mt-4 mt-lg-5"> <strong>Support</strong> </p> <p> +800 3005 4300 </p> <p> <a href="#">Contact Support</a> </p> <p> Our technical support is available by phone or email from 11am to 11pm BST, Monday through Friday. </p> <p class="text-h3 mt-4 mt-lg-5"> <strong>Sales</strong> </p> <p> +800 3005 4300 </p> <p> <a href="#">Contact Sales</a> </p> <p> Our technical support is available by phone or email from 11am to 11pm BST, Monday through Friday. </p> <p class="text-h3 mt-4 mt-lg-5"> <strong>General inquiries</strong> </p> <p> <a href="#">hello@website.com</a> </p> </div> <div class="col-12 col-md-6 ml-auto"> <h2>Drop us a line</h2> <form id="frmContact8"> <fcontact> <div class="row"> <div class="col"> <input type="text" class="form-control" name="fname" placeholder="First name"> </div> <div class="col"> <input type="text" class="form-control" name="lname" placeholder="Last name"> </div> </div> <div class="row mt-4"> <div class="col"> <input type="text" class="form-control" name="Cname" placeholder="Company Name"> </div> </div> <div class="row mt-4"> <div class="col"><input name="subject" type="text" placeholder="Subject (optional but helpful)" class="form-control"> </div> </div> <div class="row mt-4"> <div class="col"> <input type="email" class="form-control" name="email" placeholder="Email"> </div> </div> <div class="row mt-4"> <div class="col"> <input type="text" name="phone" class="form-control" placeholder="Phone"> </div> <div class="col"> <input type="text" name="country" class="form-control" placeholder="Country"> </div> </div> <div class="row mt-4"> <div class="col"> <textarea class="form-control" name="message" rows="5" placeholder="How can we help?"></textarea> </div> </div> <div class="row mt-4"> <div class="col"> <button type="submit" class="btn">Submit</button> </div> </div> </form> </fcontact> </div> </div> </div> </section>',
    attributes: {
  ...
  bm.add('froala-contents-style-8', {
    label: 'Style 8',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row"> <div class="col text-center"> <h1 style="font-size:24px">Flowz Design Blocks</h1> <h2>Subtitle comes here.</h2> <p class="text-h3"><a href="#">Learn More &gt;</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">Buy &gt;</a></p><img alt="image" class="img-fluid mt-5" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-9', {
    label: 'Style 9',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row"> <div class="col text-center"> <h1 style="font-size:24px">Flowz Design Blocks</h1> </div></div><div class="row pt-4"> <div class="col"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div><div class="col"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521362/builder/images/flowz_blocks/colors_wide_2.jpg"> </div></div><div class="row pt-4"> <div class="col"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-10', {
    label: 'Style 10',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row"> <div class="col text-center"> <h1 style="font-size:24px">Flowz Design Blocks</h1> </div></div><div class="row pt-4"> <div class="col"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div><div class="col"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div><div class="col"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-11', {
    label: 'Style 11',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row"> <div class="col text-center"> <h1 style="font-size:24px">Flowz Design Blocks</h1> </div></div><div class="row pt-4"> <div class="col-6 col-md-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div><div class="col-6 col-md-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521362/builder/images/flowz_blocks/colors_wide_2.jpg"> </div><div class="col-6 col-md-3 mt-4 mt-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div><div class="col-6 col-md-3 mt-4 mt-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521362/builder/images/flowz_blocks/colors_wide_2.jpg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-12', {
    label: 'Style 12',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row align-items-center"> <div class="col-12 col-md-6 col-lg-5"> <h1 style="font-size:24px">Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p></div><div class="col-12 col-md-6 ml-md-auto mt-4 mt-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-14', {
    label: 'Style 14',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row align-items-center"> <div class="col-12 col-md-6 mb-4 mb-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div><div class="col-12 col-md-6 col-lg-5 ml-md-auto text-left"> <h1 style="font-size:24px">Flowz Blocks</h1> <p class="text-h3" style="font-size:16px">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p><p><a class="btn btn-round mt-4" href="#" style="font-size:18px">Download</a></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-15', {
    label: 'Style 15',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block pb-0"> <div class="container"> <div class="row align-items-center"> <div class="col-12 col-md-6 col-lg-5"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_square_1.svg"/> <h1 style="font-size:24px">Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p></div><div class="col-10 col-sm-6 m-auto col-md-4 pt-4 pt-md-0"> <img alt="image" class="img-fluid br-0" src="https://res.cloudinary.com/flowz/image/upload/v1521521349/builder/images/flowz_blocks/img_tall.png"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-16', {
    label: 'Style 16',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row justify-content-center"> <div class="col-12 col-md-8 text-center"> <div class="row justify-content-center pb-4"> <div class="col-4 col-sm-3 col-md-2"><img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_square_1.svg"/></div><div class="col-4 col-sm-3 col-md-2"><img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521363/builder/images/flowz_blocks/img_square_2.svg"/></div><div class="col-4 col-sm-3 col-md-2"><img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_3.svg"/></div></div><p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-17', {
    label: 'Style 17',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block pb-0"> <div class="container"> <div class="row align-items-center"> <div class="col-10 col-sm-6 m-auto col-md-4 pb-4 pb-md-0"> <img alt="image" class="img-fluid br-0" src="https://res.cloudinary.com/flowz/image/upload/v1521521349/builder/images/flowz_blocks/img_tall.png"> </div><div class="col-12 ml-auto col-md-6 col-lg-5"> <h1 style="font-size:24px">Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p><p><a class="btn btn-round mt-4 mb-5 mb-md-0" href="#">Download</a></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-18', {
    label: 'Style 18',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row align-items-center"> <div class="col-12 col-md-12 col-lg-6 col-xl-5"> <h1 style="font-size:24px">Design Blocks</h1> <p class="text-h3 mb-5" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p><p style="font-size:16px"><strong>Works in every browser:</strong></p><p> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_square_1.svg"/> <img alt="image" class="fdb-icon ml-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521363/builder/images/flowz_blocks/img_square_2.svg"/> <img alt="image" class="fdb-icon ml-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_3.svg"/> <img alt="image" class="fdb-icon ml-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_4.svg"/></p></div><div class="col-12 col-md-8 m-auto ml-lg-auto mr-lg-0 col-lg-6 pt-5 pt-lg-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-19', {
    label: 'Style 19',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contact-style-7{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-left"> <div class="col-12 col-md-6"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_square_1.svg"/> <h3 style="font-size:16px"><strong>Awesome Things</strong></h3> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Far from the countries Vokalia and Consonantia.</p></div><div class="col-12 col-md-6 pt-5 pt-md-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521363/builder/images/flowz_blocks/img_square_2.svg"/> <h3 style="font-size:16px"><strong>More Awesomeness</strong></h3> <p class="text-h3" style="font-size:16px">Separated they live in Bookmarksgrove right at the coast of the Semantics, far far away, behind the word mountains, far from the countries <a href="#">Vokalia and Consonantia</a>, there live the blind texts. </p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-20', {
    label: 'Style 20',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contents-style-20{background-image: url(http://res.cloudinary.com/flowz/image/upload/v1521521356/builder/images/flowz_blocks/bg_c_1.svg);}</style>' +
  ...
  bm.add('froala-contents-style-21', {
    label: 'Style 21',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contents-style-21{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/alt_wide_2.svg);}</style>' +
  ...
  bm.add('froala-contents-style-23', {
    label: 'Style 23',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block pb-0"> <div class="container"> <div class="row align-items-center"> <div class="col-10 col-sm-6 col-md-5 col-lg-4 m-auto pb-5 pb-md-0"> <img alt="image" class="img-fluid br-0" src="https://res.cloudinary.com/flowz/image/upload/v1521521349/builder/images/flowz_blocks/img_tall.png"> </div><div class="col-12 ml-md-auto col-md-7 col-lg-5 pb-5 pb-md-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_square_1.svg"> <h1 style="font-size:24px">Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p><p class="mt-4"><a class="btn" href="#" style="font-size:16px">Download</a><a class="btn" href="#" style="font-size:16px">Register</a></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-24', {
    label: 'Style 24',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block pb-0"> <div class="container"> <div class="row align-items-center"> <div class="col-12 col-md-7 col-lg-5 ml-md-auto"> <h1 style="font-size:24px">Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p><p class="mt-5"> <img alt="image" height="25" class="mr-4" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/samsung.svg"> <img alt="image" height="25" class="mr-4" src="https://res.cloudinary.com/flowz/image/upload/v1521521385/builder/images/flowz_blocks/adobe.svg"> <img alt="image" height="25" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/amazon.svg"> </p></div><div class="col-10 col-sm-6 col-md-5 col-lg-4 m-auto pt-5 pt-md-0"> <img alt="image" class="img-fluid br-0" src="https://res.cloudinary.com/flowz/image/upload/v1521521349/builder/images/flowz_blocks/img_tall.png"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-25', {
    label: 'Style 25',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row"> <div class="col-12"> <div class="row justify-content-center pb-5"> <div class="col-12 col-lg-8 text-center"> <h1 style="font-size:22px">Flowz Design Blocks is Open Source and free to use</h1> </div></div><img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-26', {
    label: 'Style 26',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contents-style-26{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521356/builder/images/flowz_blocks/bg_c_1.svg);}</style>' +
  ...
  bm.add('froala-contents-style-27', {
    label: 'Style 27',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contents-style-27{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521357/builder/images/flowz_blocks/bg_c_2.svg)}</style>' +
  ...
  bm.add('froala-contents-style-29', {
    label: 'Style 29',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center align-items-center"> <div class="col-8 col-md-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521363/builder/images/flowz_blocks/img_square_2.svg"> </div><div class="col-4 col-md-2"> <div class="row"> <div class="col-12"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_3.svg"> </div></div><div class="row mt-4"> <div class="col-12"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_4.svg"> </div></div></div><div class="col-12 col-md-6 col-lg-5 ml-auto pt-5 pt-md-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h1>Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-30', {
    label: 'Style 30',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row align-items-center"> <div class="col-6 col-lg-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> </div><div class="col-6 col-lg-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521362/builder/images/flowz_blocks/colors_wide_2.jpg"> </div><div class="col-12 col-lg-6 pt-5 pt-lg-0"> <p class="text-h3 text-left" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove.</p><p class="text-h3 text-left" style="font-size:16px">Right at the coast of the Semantics, a large language ocean. A small river named Duden. <a href="#" style="font-size:16px">[Read More]</a></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-32', {
    label: 'Style 32',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center"> <div class="col-12"> <h1>Flowz Design Blocks</h1> <p class="text-h2" style="font-size:16px">Right at the coast of the Semantics, a large language ocean.</p></div></div><div class="row text-center pt-3 pt-xl-5"> <div class="col-12 col-sm-10 m-auto m-md-0 col-md-6"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p></div><div class="col-12 col-sm-10 m-auto m-md-0 col-md-6 pt-5 pt-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521362/builder/images/flowz_blocks/colors_wide_2.jpg"> <p class="text-h3">Right at the coast of the Semantics, a large language ocean. A small river named Duden.</p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-contents-style-33', {
    label: 'Style 33',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contents-style-33{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521353/builder/images/flowz_blocks/bg_0.svg);}</style>' +
  ...
  bm.add('froala-contents-style-34', {
    label: 'Style 34',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;} .contents-style-34{background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg);}</style>' +
  ...
  bm.add('froala-features-style-7', {
    label: 'Style 7',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center"> <div class="col-12 col-sm-6 col-lg-5 col-xl-4 m-auto"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature 1</strong></h3> <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p></div><div class="col-12 col-sm-6 col-lg-5 col-xl-4 m-auto pt-4 pt-sm-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature 2</strong></h3> <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-8', {
    label: 'Style 8',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center"> <div class="col-12"> <h1 style="font-size:24px">Features</h1> <img alt="image" class="img-fluid mt-5" src="https://res.cloudinary.com/flowz/image/upload/v1521521352/builder/images/flowz_blocks/img_very_wide.svg"> </div></div><div class="row text-center justify-content-center mt-5"> <div class="col-12 col-sm-4 col-lg-3 m-md-auto"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature 1</strong></h3> </div><div class="col-12 col-sm-4 col-lg-3 m-auto pt-4 pt-sm-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature 2</strong></h3> </div><div class="col-12 col-sm-4 col-lg-3 m-auto pt-4 pt-sm-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature 3</strong></h3> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-10', {
    label: 'Style 10',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center"> <div class="col-12"> <h1 style="font-size:24px">Features</h1> </div></div><div class="row text-center justify-content-center mt-5"> <div class="col-12 col-sm-6 col-lg-3"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature One</strong></h3> <p>Far far away, behind the word mountains, far from the countries</p></div><div class="col-12 col-sm-6 col-lg-3 pt-4 pt-sm-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature Two</strong></h3> <p>Separated they live in Bookmarksgrove right at the coast</p></div><div class="col-12 col-sm-6 col-lg-3 pt-4 pt-lg-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature Three</strong></h3> <p>A small river named Duden flows by their place and supplies it</p></div><div class="col-12 col-sm-6 col-lg-3 pt-4 pt-lg-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature Four</strong></h3> <p>Duden flows by their place far far away, behind the word mountains.</p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-11', {
    label: 'Style 11',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center"> <div class="col-12"> <h1 style="font-size:24px">Features</h1> </div></div><div class="row text-left mt-5"> <div class="col-12 col-md-4"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature One</strong></h3> <p>Far far away, behind the word mountains, far from the countries</p></div></div></div><div class="col-12 col-md-4 pt-3 pt-sm-4 pt-md-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Two</strong></h3> <p>Even the all-powerful Pointing has no control about the blind texts.</p></div></div></div><div class="col-12 col-md-4 pt-3 pt-sm-4 pt-md-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Three</strong></h3> <p>A small river named Duden flows by their place and supplies it</p></div></div></div></div><div class="row text-left pt-3 pt-sm-4 pt-md-5"> <div class="col-12 col-md-4"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Four</strong></h3> <p>Duden flows by their place far far away, behind the word mountains.</p></div></div></div><div class="col-12 col-md-4 pt-3 pt-sm-4 pt-md-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Five</strong></h3> <p>Separated they live in Bookmarksgrove right at the coast</p></div></div></div><div class="col-12 col-md-4 pt-3 pt-sm-4 pt-md-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Six</strong></h3> <p>On her way she met a copy. The copy warned the Little Blind Text.</p></div></div></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-12', {
    label: 'Style 12',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center"> <div class="col-12"> <h1 style="font-size:24px">Features</h1> </div></div><div class="row text-left mt-5"> <div class="col-12 col-sm-6 col-lg-3"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:16px"><strong>Feature One</strong></h3> <p>Even the all-powerful Pointing has no control about the blind texts</p></div></div></div><div class="col-12 col-sm-6 col-lg-3 pt-3 pt-sm-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:16px"><strong>Feature Two</strong></h3> <p>Separated they live in Bookmarksgrove right at the coast</p></div></div></div><div class="col-12 col-sm-6 col-lg-3 pt-3 pt-lg-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:16px"><strong>Feature Three</strong></h3> <p>A small river named Duden flows by their place and supplies it</p></div></div></div><div class="col-12 col-sm-6 col-lg-3 pt-3 pt-lg-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:16px"><strong>Feature Four</strong></h3> <p>Far far away, behind the word mountains, far from the countries</p></div></div></div></div><div class="row text-left pt-3 pt-lg-5"> <div class="col-12 col-sm-6 col-lg-3"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:16px"><strong>Feature Five</strong></h3> <p>On her way she met a copy. The copy warned the Little Blind Text.</p></div></div></div><div class="col-12 col-sm-6 col-lg-3 pt-3 pt-sm-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:16px"><strong>Feature Six</strong></h3> <p>Far far away, behind the word mountains, far from the countries</p></div></div></div><div class="col-12 col-sm-6 col-lg-3 pt-3 pt-lg-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:16px"><strong>Feature Seven</strong></h3> <p>Duden flows by their place far far away, behind the word mountains.</p></div></div></div><div class="col-12 col-sm-6 col-lg-3 pt-3 pt-lg-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:16px"><strong>Feature Eight</strong></h3> <p>Separated they live in Bookmarksgrove right at the coast</p></div></div></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-13', {
    label: 'Style 13',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block pb-0"> <div class="container"> <div class="row text-lg-right align-items-center"> <div class="col-12 col-sm-6 col-lg-3"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px"><strong>Feature One</strong></h4> <p>Far far away, behind the word mountains is hope.</p><img alt="image" class="fdb-icon mt-3 mt-xl-5" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px"><strong>Feature Two</strong></h4> <p>On her way she met a copy of the Little Blind Text.</p><img alt="image" class="fdb-icon mt-3 mt-xl-5" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px"><strong>Feature Three</strong></h4> <p>Even the all-powerful has no control about the blind texts</p></div><div class="col-12 col-sm-6 col-lg-3 text-left pt-3 pt-sm-0 order-lg-12"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px"><strong>Feature Four</strong></h4> <p>Duden flows by their place, behind the word mountains.</p><img alt="image" class="fdb-icon mt-3 mt-xl-5" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px"><strong>Feature Five</strong></h4> <p>Separated they live in Bookmark right at the coast</p><img alt="image" class="fdb-icon mt-3 mt-xl-5" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px"><strong>Feature Six</strong></h4> <p>A small river named Duden flows by their place and supplies it</p></div><div class="col-7 col-sm-4 col-lg-4 m-auto pt-5 pt-lg-0 order-lg-1"> <img alt="image" class="img-fluid br-b-0" src="https://res.cloudinary.com/flowz/image/upload/v1521521351/builder/images/flowz_blocks/img_very_tall.png"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-14', {
    label: 'Style 14',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block pb-md-0"> <div class="container"> <div class="row text-right align-items-center"> <div class="col-7 col-md-4 m-auto"> <img alt="image" class="img-fluid br-b-0" src="https://res.cloudinary.com/flowz/image/upload/v1521521351/builder/images/flowz_blocks/img_very_tall.png"> </div><div class="col-12 col-md-7 col-lg-5 m-auto text-left pt-5 pt-md-0"> <div class="row pb-lg-5"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Seven</strong></h3> <p>Even the all-powerful Pointing has no control about the blind texts.</p></div></div><div class="row pt-4 pt-md-5 pb-lg-5"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Seven</strong></h3> <p>Duden flows by their place far far away, behind the word mountains.</p></div></div><div class="row pt-4 pt-md-5"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Seven</strong></h3> <p>A small river named Duden flows by their place and supplies it.</p></div></div></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-15', {
    label: 'Style 15',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block pb-0"> <div class="container"> <div class="row text-right align-items-center"> <div class="col-12 col-lg-6 col-xl-5 m-lg-auto text-left"> <h1>Features</h1> <p class="text-h3 pb-xl-4" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p><div class="row pt-5"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences.</p></div></div><div class="row pt-5"> <div class="col-9 text-right"> <p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, there live the blind texts.</p></div><div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div></div></div><div class="col-7 col-sm-4 m-auto pt-5 pt-md-0"> <img alt="image" class="img-fluid br-b-0" src="https://res.cloudinary.com/flowz/image/upload/v1521521351/builder/images/flowz_blocks/img_very_tall.png"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-17', {
    label: 'Style 17',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row justify-content-center"> <div class="col-12 text-left"> <h1>Flowz Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p><img alt="image" class="img-fluid mt-5" src="https://res.cloudinary.com/flowz/image/upload/v1521521352/builder/images/flowz_blocks/img_very_wide.svg"> </div></div><div class="row text-left mt-5"> <div class="col-12 col-md-4"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature One</strong></h3> <p>Far far away, behind the word mountains, far from the countries</p></div></div></div><div class="col-12 col-md-4 pt-4 pt-md-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Two</strong></h3> <p>Separated they live in Bookmarksgrove right at the coast</p></div></div></div><div class="col-12 col-md-4 pt-4 pt-md-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Three</strong></h3> <p>A small river named Duden flows by their place and supplies it</p></div></div></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-18', {
    label: 'Style 18',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row justify-content-center"> <div class="col-12 text-center"> <h1>Features</h1> </div></div><div class="row text-center mt-5"> <div class="col-12 col-sm-4"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature One</strong></h3> <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p></div><div class="col-12 col-sm-4 pt-4 pt-sm-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature Two</strong></h3> <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. </p></div><div class="col-12 col-sm-4 pt-4 pt-sm-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Feature Three</strong></h3> <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country,</p></div></div><div class="row mt-5"> <div class="col-12"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521352/builder/images/flowz_blocks/img_very_wide.svg"> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-19', {
    label: 'Style 19',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row justify-content-center"> <div class="col-12 text-left"> <h1>Flowz Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p></div></div><div class="row text-left mt-5"> <div class="col-12 col-sm-8 col-md-4 col-lg-3 m-sm-auto mr-md-auto ml-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_square_1.svg"> <h3 style="font-size:20px"><strong>Feature One</strong></h3> <p>Far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p></div><div class="col-12 col-sm-8 col-md-4 col-lg-3 m-sm-auto pt-5 pt-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521363/builder/images/flowz_blocks/img_square_2.svg"> <h3style="font-size:20px"><strong>Feature Two</strong></h3> <p> It is a paradisematic country, in which roasted parts of sentences fly into your mouth. Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life.</p></div><div class="col-12 col-sm-8 col-md-4 col-lg-3 m-sm-auto ml-md-auto mr-md-0 pt-5 pt-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_3.svg"> <h3 style="font-size:20px"><strong>Feature Three</strong></h3> <p>The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and devious Semikoli, but the Little Blind Text didn’t listen.</p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-21', {
    label: 'Style 21',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row justify-content-center"> <div class="col-12 text-left"> <h1>Flowz Design Blocks</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word "and" and the Little Blind Text.</p></div></div><div class="row text-left pt-5"> <div class="col-12 col-sm-6 col-md-5"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521363/builder/images/flowz_blocks/img_square_2.svg"> <h3 style="font-size:20px"><strong>Feature One</strong></h3> <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p></div><div class="col-12 col-sm-6 col-md-5 ml-sm-auto pt-5 pt-sm-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_4.svg"> <h3 style="font-size:20px"><strong>Feature Two</strong></h3> <p>It is a paradisematic country, in which roasted parts of sentences fly into your mouth. Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life.</p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-23', {
    label: 'Style 23',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row"> <div class="col-12 col-md-10 col-lg-8 text-left"> <h1>Flowz Design Blocks is simply ahead the word mountains</h1> <p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p><p class="text-h3"><a href="#" style="font-size:20px">Explore all features &gt;</a></p></div></div><div class="row text-center no-gutters pt-5"> <div class="col-12 col-md-10 col-lg-8"> <div class="row"> <div class="col-8 col-sm-5 col-md-2 m-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px">Feature One</h4> </div><div class="col-8 col-sm-5 col-md-2 m-auto pt-5 pt-sm-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px">Feature Two</h4> </div><div class="col-8 col-sm-5 col-md-2 m-auto pt-5 pt-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px">Feature Three</h4> </div><div class="col-8 col-sm-5 col-md-2 m-auto pt-5 pt-md-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h4 style="font-size:18px">Feature Four</h4> </div></div></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-24', {
    label: 'Style 24',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row align-items-top"> <div class="col-12 col-md-6 col-xl-4 m-auto"> <h2>Learn more about the Flowz Design Blocks you love</h2> </div><div class="col-12 col-md-6 pt-5 pt-md-0"> <div class="row justify-content-left"> <div class="col-3 m-auto text-center"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <p><a href="#">One &gt;</a></p></div><div class="col-3 m-auto text-center"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <p><a href="#">Two &gt;</a></p></div><div class="col-3 m-auto text-center"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <p><a href="#">Three &gt;</a></p></div></div><div class="row justify-content-left mt-4 mt-xl-5"> <div class="col-3 m-auto text-center"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <p><a href="#">Four &gt;</a></p></div><div class="col-3 m-auto text-center"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <p><a href="#">Five &gt;</a></p></div></div></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-25', {
    label: 'Style 25',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center"> <div class="col-12"> <h1>There is a feature for everyone</h1> <p class="text-h3"><a href="#" style="font-size:16px">See all features &gt;</a> </div></div><div class="row text-center justify-content-center mt-5"> <div class="col-10 col-sm-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_square_1.svg"> <h3 style="font-size:16px"><strong>Feature One</strong></h3> </div><div class="col-10 col-sm-3 pt-5 pt-sm-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_4.svg"> <h3 style="font-size:16px"><strong>Feature Two</strong></h3> </div><div class="col-10 col-sm-3 pt-5 pt-sm-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521363/builder/images/flowz_blocks/img_square_2.svg"> <h3 style="font-size:16px"><strong>Feature Three</strong></h3> </div><div class="col-10 col-sm-3 pt-5 pt-sm-0"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_3.svg"> <h3 style="font-size:16px"><strong>Feature Four</strong></h3> </div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-27', {
    label: 'Style 27',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row justify-content-center pb-xl-5"> <div class="col-12 col-sm-11 text-center"> <h1>Flowz Design Blocks</h1> <img alt="image" class="img-fluid mt-5" src="https://res.cloudinary.com/flowz/image/upload/v1521521352/builder/images/flowz_blocks/img_very_wide.svg"> </div></div><div class="row text-left justify-content-center pt-5"> <div class="col-12 col-md-6 col-lg-5 m-sm-auto"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature One</strong></h3> <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life.</p></div></div></div><div class="col-12 col-md-6 col-lg-5 m-sm-auto pt-3 pt-sm-5 pt-md-0"> <div class="row"> <div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> </div><div class="col-9"> <h3 style="font-size:20px"><strong>Feature Two</strong></h3> <p>Separated they live in Bookmarksgrove, right at the coast of the Semantics, a large language ocean.</p></div></div></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-29', {
    label: 'Style 29',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row justify-content-center"> <div class="col-12col-md-10 col-lg-8 text-center"> <h1>Flowz Design Blocks</h1> </div></div><div class="row justify-content-center text-center mt-5"> <div class="col-12 col-sm-6 col-md-5 col-lg-3"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:16px"><strong>Feature one longer Text</strong></h3> </div><div class="col-12 col-sm-6 col-md-5 col-lg-3 pt-4 pt-sm-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:16px"><strong>Feature two shorter</strong></h3> </div></div><div class="row justify-content-center text-center mt-5 mt-md-4"> <div class="col-12 col-md-10 col-lg-8"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521352/builder/images/flowz_blocks/img_very_wide.svg"> <p><em>Coming this fall</em></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-30', {
    label: 'Style 30',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center"> <div class="col-12 col-sm-6 col-md-3"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>The all-powerful Pointing has no control</strong></h3> <p class="mt-3"><a class="btn" href="#">Learn</a></p></div><div class="col-12 col-sm-6 col-md-3 pt-5 pt-sm-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>Far far away, behind the word mountains</strong></h3> <p class="mt-3"><a class="btn" href="#">Learn</a></p></div><div class="col-12 col-sm-6 col-md-3 pt-5 pt-md-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>The Big Oxmox advised her not to do so</strong></h3> <p class="mt-3"><a class="btn" href="#">Learn</a></p></div><div class="col-12 col-sm-6 col-md-3 pt-5 pt-md-0"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h3 style="font-size:20px"><strong>The copy warned the Little Blind Text</strong></h3> <p class="mt-3"><a class="btn" href="#">Learn</a></p></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-features-style-31', {
    label: 'Style 31',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>' +
      '<section class="fdb-block"> <div class="container"> <div class="row text-center"> <div class="col-12 col-md-8 m-auto col-lg-4"> <div class="fdb-box fdb-touch"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h2>Feature 1</h2> <p>Far far away, behind the word mountains, far from the countries.</p></div></div><div class="col-12 col-md-8 m-auto col-lg-4 pt-5 pt-lg-0"> <div class="fdb-box fdb-touch"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h2>Feature 2</h2> <p>Separated they live in Bookmarksgrove right at the coast.</p></div></div><div class="col-12 col-md-8 m-auto col-lg-4 pt-5 pt-lg-0"> <div class="fdb-box fdb-touch"> <img alt="image" class="fdb-icon" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"> <h2>Feature 3</h2> <p>A small river named Duden flows by their place and supplies.</p></div></div></div></div></section>',
    attributes: {
  ...
  bm.add('froala-forms-style-5', {
    label: 'Style 5',
    content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style>  <section class="fdb-block" style="background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521354/builder/images/flowz_blocks/bg_4.svg)"> <div class="container"> <div class="row justify-content-end"> <div class="col-12 col-md-8 col-lg-6 col-xl-5 text-left"> <div class="fdb-box"> <div class="row"> <div class="col"> <h1>Log In</h1> <p class="text-h3">Right at the coast of the Semantics, a large language ocean. A small river named Duden.</p></div></div><div class="row"> <div class="col mt-4"> <input type="text" class="form-control" placeholder="Email"> </div></div><div class="row mt-4"> <div class="col"> <input type="password" class="form-control" placeholder="Password"> </div></div><div class="row mt-4"> <div class="col"> <button class="btn" type="button">Submit</button> </div></div></div></div></div></div></section>',
    attributes: {
  ...
  //   label: 'Style 7',
  //   content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style> <section class="fdb-block" style="background-image: url(http://res.cloudinary.com/flowz/image/upload/v1521521353/builder/images/flowz_blocks/bg_0.svg)"> <div class="container"> <div class="row justify-content-center"> <div class="col-12 col-md-8 col-lg-7 col-xl-5 text-center"> <div class="fdb-box fdb-touch"> <div class="row"> <div class="col"> <h1>Log In</h1> </div></div><div class="row mt-4"> <div class="col"> <input type="text" class="form-control" placeholder="Email"> </div></div><div class="row mt-4"> <div class="col"> <input type="password" class="form-control mb-1" placeholder="Password"> <p class="text-right"><a href="https://www.flowz.com">Recover Password</a></p></div></div><div class="row mt-4"> <div class="col"> <button class="btn" type="button">Submit</button> </div></div></div></div></div></div></section>',
  //   attributes: {
  ...
  //   label: 'Style 12',
  //   content: '<style>.fdb-block{border-bottom: solid 1px #EEE;}</style> <section class="fdb-block" style="background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521357/builder/images/flowz_blocks/bg_c_2.svg);"> <div class="container"> <div class="row justify-content-end"> <div class="col-12 col-md-9 col-lg-8"> <div class="fdb-box fdb-touch"> <div class="row justify-content-center"> <div class="col-12 col-lg-10"> <h1>Subscribe</h1> <p class="text-h3">When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove.</p></div></div><div class="row justify-content-center mt-4"> <div class="col-12 col-lg-10"> <div class="input-group"> <input type="text" class="form-control" placeholder="Enter your email address"> <span class="input-group-btn"> <button class="btn" type="button">Submit</button> </span> </div></div></div></div></div></div></div></section>',
  //   attributes: {
  ...
  bm.add('froala-pricings-style-6', {
    label: 'Style 6',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block"><div class="container"><div class="row text-center"><div class="col"><h1>Pricing Plans</h1></div></div><div class="row mt-5 align-items-top"><div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left"><div class="br"><div class="bg-dark p-3 text-center"><h2 class="font-weight-light">Startup</h2><p class="text-h2"><strong>$9.90</strong></p></div><div class="bg-gray p-5 text-center"><p><img alt="image" height="40" src=" https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></p><p class="text-h4"><strong>For small companies</strong></p><p><br></p><p>10 hours of support</p><p>40MB of storage</p><p>Subdomain</p><p class="text-center pt-5"><a href="https://www.flowz.com" class="btn btn-round">Choose Plan</a></p></div></div></div><div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left pt-4 pt-lg-0"><div class="br"><div class="bg-dark p-3 text-center"><h2 class="font-weight-light">Standard</h2><p class="text-h2"><strong>$19.90</strong></p></div><div class="bg-gray p-5 text-center"><p><img alt="image" height="40" src=" https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></p><p class="text-h4"><strong>For medium companies</strong></p><p><br></p><p>10 hours of support</p><p>40MB of storage</p><p>Subdomain</p><p class="text-center pt-5"><a href="https://www.flowz.com" class="btn btn-round">Choose Plan</a></p></div></div></div><div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left pt-4 pt-lg-0"><div class="br"><div class="bg-dark p-3 text-center"><h2 class="font-weight-light">Business</h2><p class="text-h2"><strong>$29.90</strong></p></div><div class="bg-gray p-5 text-center"><p><img alt="image" height="40" src=" https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></p><p class="text-h4"><strong>For large companies</strong></p><p><br></p><p>10 hours of support</p><p>40MB of storage</p><p>Subdomain</p><p class="text-center pt-5"><a href="https://www.flowz.com" class="btn btn-round">Choose Plan</a></p></div></div></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-pricings-style-8', {
    label: 'Style 8',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block"><div class="container"><div class="row text-center"><div class="col"><h1>Pricing Plans</h1></div></div><div class="row mt-5 align-items-top"><div class="col-12 col-md-8 m-auto col-lg-4 text-center"> <img alt="image" height="80" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h2><strong>Startup</strong></h2><p class="text-h3 mb-4 mb-lg-5"><em>$9 / month</em></p><p>10 hours of support</p><p>40MB of storage</p><p>Subdomain</p><p class="text-center mt-4 mt-lg-5"><a href="https://www.flowz.com" class="btn btn-round">Choose Plan</a></p></div><div class="col-12 col-md-8 col-lg-4 text-center m-auto pt-5 pt-lg-0"> <img alt="image" height="80" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h2><strong>Advanced</strong></h2><p class="text-h3 mb-4 mb-lg-5"><em>$19 / month</em></p><p>10 hours of support</p><p>40MB of storage</p><p>Subdomain</p><p class="text-center mt-4 mt-lg-5"><a href="https://www.flowz.com" class="btn btn-round">Choose Plan</a></p></div><div class="col-12 col-md-8 m-auto col-lg-4 text-center pt-5 pt-lg-0"> <img alt="image" height="80" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h2><strong>Business</strong></h2><p class="text-h3 mb-4 mb-lg-5"><em>$29 / month</em></p><p>10 hours of support</p><p>40MB of storage</p><p>Subdomain</p><p class="text-center mt-4 mt-lg-5"><a href="https://www.flowz.com" class="btn btn-round">Choose Plan</a></p></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-teams-style-1', {
    label: 'Style 1',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block team-1"><div class="container"><div class="row text-center justify-content-center"><div class="col-8"><h1>Our Team</h1><p class="text-h3" style="font-size:18px">Far far away, behind the word mountains, far from the countries.</p></div></div><div class="row-50"></div><div class="row"><div class="col-sm-3 text-left"><div class="fdb-box"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_square_1.svg"><div class="content"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>Founder</p></div></div></div><div class="col-sm-3 text-left"><div class="fdb-box"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521363/builder/images/flowz_blocks/img_square_2.svg"><div class="content"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>Founder</p></div></div></div><div class="col-sm-3 text-left"><div class="fdb-box"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_3.svg"><div class="content"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>Founder</p></div></div></div><div class="col-sm-3 text-left"><div class="fdb-box"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521348/builder/images/flowz_blocks/img_square_4.svg"><div class="content"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>Founder</p></div></div></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-teams-style-2', {
    label: 'Style 2',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block team-2"><div class="container"><div class="row text-center justify-content-center"><div class="col-8"><h1>Meet Our Team</h1></div></div><div class="row-50"></div><div class="row text-center justify-content-center"><div class="col-sm-3 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h2>Sara Doe</h2><p>Founder</p></div><div class="col-sm-3 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h2>Sara Doe</h2><p>Founder</p></div><div class="col-sm-3 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h2>Sara Doe</h2><p>Founder</p></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-teams-style-3', {
    label: 'Style 3',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block team-3"><div class="container"><div class="row text-center justify-content-center"><div class="col-8"><h1>Meet Our Team</h1></div></div><div class="row-70"></div><div class="row text-center justify-content-center"><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src=" https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p><em>Founder</em></p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p><em>Founder</em></p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p><em>Founder</em></p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p><em>Founder</em></p></div></div><div class="row justify-content-center text-center"><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p><em>Founder</em></p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p><em>Founder</em></p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p><em>Founder</em></p></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-teams-style-4', {
    label: 'Style 4',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block team-4"><div class="container"><div class="row text-center justify-content-center"><div class="col-8"><h1>Team</h1></div></div><div class="row text-center"><div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"><h3 style="font-size:16px"><strong>John Smith</strong></h3><p>Position</p><p>A wonderful serenity has taken possession of my entire soul.</p></div><div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"><h3 style="font-size:16px"><strong>John Smith</strong></h3><p>Position</p><p>Pityful a rethoric question ran over her cheek.</p></div><div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"><h3 style="font-size:16px"><strong>John Smith</strong></h3><p>Position</p><p>And if she hasn’t been rewritten, then they are still using her.</p></div><div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"><h3 style="font-size:16px"><strong>John Smith</strong></h3><p>Position</p><p>Wild Question Marks, but the Little Blind Text didn’t listen.</p></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-teams-style-5', {
    label: 'Style 5',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block team-5"><div class="container"><div class="row text-center justify-content-center"><div class="col-8"><h1>Meet Our Team</h1></div></div><div class="row-70"></div><div class="row text-center justify-content-center"><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>"Wild Question Marks, but the Little Blind"</p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>"Wild Question Marks, but the Little Blind"</p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>"Wild Question Marks, but the Little Blind"</p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>"Wild Question Marks, but the Little Blind"</p></div></div><div class="row justify-content-center text-center"><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>"Wild Question Marks, but the Little Blind"</p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>"Wild Question Marks, but the Little Blind"</p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>"Wild Question Marks, but the Little Blind"</p></div><div class="col-sm-2 m-sm-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"><h3 style="font-size:16px"><strong>Sara Doe</strong></h3><p>"Wild Question Marks, but the Little Blind"</p></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-teams-style-6', {
    label: 'Style 6',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block team-6"><div class="container"><div class="row text-center justify-content-center"><div class="col-8"><h1>Team</h1></div></div><div class="row text-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"><h3 style="font-size:16px"><strong>John Smith</strong></h3><p>Position</p><p>Separated they live in Bookmarksgrove right at the coast of the Semantics.</p></div><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"><h3 style="font-size:16px"><strong>John Smith</strong></h3><p>Position</p><p>One morning, when Gregor Samsa woke from troubled dreams.</p></div><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521360/builder/images/flowz_blocks/colors_wide_1.jpg"><h3 style="font-size:16px"><strong>John Smith</strong></h3><p>Position</p><p>A small river named Duden flows by their place and supplies it.</p></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-teams-style-7', {
    label: 'Style 7',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block team-7"><div class="container"><div class="row text-center justify-content-center"><div class="col-8"><h1>Team</h1></div></div><div class="row-70"></div><div class="row justify-content-center"><div class="col-sm-3 m-sm-auto"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px">Employee Name</h3><p>Position</p></div></div></div><div class="col-sm-3 m-sm-auto"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px">Employee Name</h3><p>Position</p></div></div></div><div class="col-sm-3 m-sm-auto"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px">Employee Name</h3><p>Position</p></div></div></div></div><div class="row-50"></div><div class="row justify-content-center"><div class="col-sm-3 m-sm-auto"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px">Employee Name</h3><p>Position</p></div></div></div><div class="col-sm-3 m-sm-auto"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px">Employee Name</h3><p>Position</p></div></div></div><div class="col-sm-3 m-sm-auto"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px">Employee Name</h3><p>Position</p></div></div></div></div><div class="row-50"></div><div class="row justify-content-center"><div class="col-sm-3 m-sm-auto"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px">Employee Name</h3><p>Position</p></div></div></div><div class="col-sm-3 m-sm-auto"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px">Employee Name</h3><p>Position</p></div></div></div><div class="col-sm-3 m-sm-auto"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px">Employee Name</h3><p>Position</p></div></div></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-teams-style-8', {
    label: 'Style 8',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block team-8"><div class="container"><div class="row text-center justify-content-center"><div class="col-8"><h1>Our Amazing Team</h1><p class="text-h3">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p></div></div><div class="row-100"></div><div class="row justify-content-center text-left"><div class="col-sm-6"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px"><strong>Employee Name</strong></h3><p class="text-h3" style="font-size:14px">Position</p><p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p></div></div></div><div class="col-sm-6"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px"><strong>Employee Name</strong></h3><p class="text-h3" style="font-size:14px">Position</p><p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p></div></div></div></div><div class="row-70"></div><div class="row justify-content-center text-left"><div class="col-sm-6"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px"><strong>Employee Name</strong></h3><p class="text-h3" style="font-size:14px">Position</p><p>One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p></div></div></div><div class="col-sm-6"><div class="row align-items-center"><div class="col-4"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></div><div class="col-8"><h3 style="font-size:16px"><strong>Employee Name</strong></h3><p class="text-h3" style="font-size:14px">Position</p><p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life.</p></div></div></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-testimonials-style-2', {
    label: 'Style 2',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block" style="background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521355/builder/images/flowz_blocks/bg_3.svg)"><div class="container"><div class="fdb-box"><div class="row align-items-center justify-content-center"><div class="col-10 col-sm-6 col-md-4 col-lg-3 col-xl-2 m-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"/></div><div class="col-12 col-md-8 ml-auto mr-auto mt-4 mt-md-0"><p class="text-h3" style="font-size:16px"> "Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar."</p><p class="text-h3 mt-4 mt-lg-5" style="font-size:18px"><strong>Person Name</strong></p><p style="font-size:20px"><em>Co-founder at Company</em></p></div></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-testimonials-style-3', {
    label: 'Style 3',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block"><div class="container"><div class="row text-center"><div class="col-12"><h3 style="font-size:22px"><strong>You are in good company</strong></h3><div class="mt-5 justify-content-center"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://s3-us-west-2.amazonaws.com/airflowbucket1/flowz-builder/imgs/customers/adobe.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521385/builder/images/flowz_blocks/discovery.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521382/builder/images/flowz_blocks/ebay.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/samsung.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/orange.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/salesforce.svg"></div><div class="mt-2 mt-md-5 justify-content-center"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/cisco.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521382/builder/images/flowz_blocks/apple.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/ibm.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521384/builder/images/flowz_blocks/intel.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521382/builder/images/flowz_blocks/panasonic.svg"></div></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-testimonials-style-5', {
    label: 'Style 5',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block" style="background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521356/builder/images/flowz_blocks/bg_2.svg)"><div class="container"><div class="row align-items-center justify-content-center"><div class="col-lg-9 col-xl-6"><div class="fdb-box"><div class="row"><div class="col-8 col-sm-6 col-md-4 col-xl-3 ml-auto mr-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"/></div><div class="col-md-8 mt-4 mt-md-0"><p class="text-h3" style="font-size:16px"> "Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar."</p><p class="text-h3 mt-4 mt-xl-5" style="font-size:17px"><strong>Person Name</strong></p><p style="font-size:18px"><em>Co-founder at Company</em></p></div></div></div></div><div class="col-lg-9 col-xl-6 mt-4 mt-xl-0"><div class="fdb-box"><div class="row"><div class="col-8 col-sm-6 col-md-4 col-xl-3 ml-auto mr-auto"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"/></div><div class="col-md-8 mt-4 mt-md-0"><p class="text-h3" style="font-size:16px"> "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean."</p><p class="text-h3 mt-4 mt-xl-5" style="font-size:17px"><strong>Person Name</strong></p><p style="font-size:18px"><em>Co-founder at Company</em></p></div></div></div></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-testimonials-style-6', {
    label: 'Style 6',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block"><div class="container"><div class="row text-center justify-content-center"><div class="col-lg-8"><h2>You are in good company</h2><p class="text-h3" style="font-size:16px">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p><div class="mt-5 justify-content-center"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://s3-us-west-2.amazonaws.com/airflowbucket1/flowz-builder/imgs/customers/adobe.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521385/builder/images/flowz_blocks/discovery.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521382/builder/images/flowz_blocks/ebay.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/samsung.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/orange.svg"> <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/salesforce.svg"></div></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-testimonials-style-7', {
    label: 'Style 7',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block bg-dark"><div class="container"><div class="row justify-content-center text-center"><div class="col"> <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="https://s3-us-west-2.amazonaws.com/airflowbucket1/flowz-builder/imgs/customers/adobe.svg"> <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="https://s3-us-west-2.amazonaws.com/airflowbucket1/flowz-builder/imgs/customers/discovery.svg"> <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521382/builder/images/flowz_blocks/ebay.svg"> <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/samsung.svg"> <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/orange.svg"> <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/salesforce.svg"></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-testimonials-style-8', {
    label: 'Style 8',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block"><div class="container"><div class="row pb-xl-5 text-center justify-content-center"><div class="col-md-10 col-lg-7"><h1>Testimonials</h1></div></div><div class="row mt-5 justify-content-center"><div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center"> <img alt="image" height="50" src="https://res.cloudinary.com/flowz/image/upload/v1521521384/builder/images/flowz_blocks/intel.svg"><p class="text-h3 mt-3" style="font-size:16px">"Far far away, behind the word mountains, far from the countries Vokalia and Consonantia."</p><p class="text-h3 mt-4 mt-xl-5"><strong>Person Name</strong></p><p>Co-founder at Company</p></div><div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center"> <img alt="image" height="50" src="https://s3-us-west-2.amazonaws.com/airflowbucket1/flowz-builder/imgs/customers/apple.svg"><p class="text-h3 mt-3" style="font-size:16px">"Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean."</p><p class="text-h3 mt-4 mt-xl-5"><strong>Person Name</strong></p><p>Co-founder at Company</p></div><div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center"> <img alt="image" height="50" src="https://res.cloudinary.com/flowz/image/upload/v1521521378/builder/images/flowz_blocks/samsung.svg"><p class="text-h3 mt-3" style="font-size:16px">"A small river named Duden flows by their place and supplies it with the necessary regelialia."</p><p class="text-h3 mt-4 mt-xl-5"><strong>Person Name</strong></p><p>Co-founder at Company</p></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-testimonials-style-9', {
    label: 'Style 9',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block bg-dark" style="background-image: url(https://res.cloudinary.com/flowz/image/upload/v1521521354/builder/images/flowz_blocks/bg_4.svg)"><div class="container"><div class="row text-center justify-content-center"><div class="col-md-10 col-lg-8 col-xl-7"><h1>Testimonials</h1><p class="text-h3" style="font-size:16px">A small river named Duden flows by their place and supplies it with the necessary regelialia. Separated they live in Bookmarksgrove right at the coast of the Semantics.</p></div></div><div class="row mt-5 align-items-center justify-content-center"><div class="col-md-8 col-lg-4"><div class="fdb-box"><div class="row no-gutters align-items-center"><div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"/></div><div class="col-8 ml-auto"><p> <strong>Person Name</strong><br> <em>Co-founder at Company</em></p></div></div><div class="row mt-4"><div class="col-12"><p class="text-h3" style="font-size:16px"> "Even the all-powerful Pointing has no control about the blind texts it is an unorthographic life. One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar."</p></div></div></div></div><div class="col-md-8 col-lg-4 mt-4 mt-lg-0"><div class="fdb-box"><div class="row no-gutters align-items-center"><div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"/></div><div class="col-8 ml-auto"><p> <strong>Person Name</strong><br> <em>Co-founder at Company</em></p></div></div><div class="row mt-4"><div class="col-12"><p class="text-h3" style="font-size:16px"> "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean."</p></div></div></div></div><div class="col-md-8 col-lg-4 mt-4 mt-lg-0"><div class="fdb-box"><div class="row no-gutters align-items-center"><div class="col-3"> <img alt="image" class="img-fluid" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"/></div><div class="col-8 ml-auto"><p> <strong>Person Name</strong><br> <em>Co-founder at Company</em></p></div></div><div class="row mt-4"><div class="col-12"><p class="text-h3" style="font-size:16px"> "Separated they live in Bookmarksgrove right at the coast of the Semantics, far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts."</p></div></div></div></div></div></div> </section>',
    attributes: {
  ...
  bm.add('froala-testimonials-style-10', {
    label: 'Style 10',
    content: '<style>.fdb-block{border-bottom:solid 1px #EEE}</style><section class="fdb-block"><div class="container"><div class="row text-center justify-content-center"><div class="col-md-10 col-lg-7"><h1>Testimonials</h1></div></div><div class="row mt-5 justify-content-center"><div class="col-md-10 col-lg-3 ml-auto mr-auto text-center"><p class="text-h3 mb-4 mb-lg-5" style="font-size:16px">"Far far away, behind the word mountains, far from the countries Vokalia and Consonantia."</p><p><img alt="image" height="50" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></p><p class="text-h3" style="font-size:15px"><strong>Person Name</strong></p><p>Co-founder, Company</p></div><div class="col-md-10 col-lg-3 pt-5 pt-lg-0 ml-auto mr-auto text-center"><p class="text-h3 mb-4 mb-lg-5" style="font-size:16px">"Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean."</p><p><img alt="image" height="50" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></p><p class="text-h3" style="font-size:15px"><strong>Person Name</strong></p><p>Co-founder, Company</p></div><div class="col-md-10 col-lg-3 pt-5 pt-lg-0 ml-auto mr-auto text-center"><p class="text-h3 mb-4 mb-lg-5" style="font-size:16px">"A small river named Duden flows by their place and supplies it with the necessary regelialia."</p><p><img alt="image" height="50" src="https://res.cloudinary.com/flowz/image/upload/v1521521364/builder/images/flowz_blocks/img_round.svg"></p><p class="text-h3" style="font-size:15px"><strong>Person Name</strong></p><p>Co-founder, Company</p></div></div></div> </section>',
    attributes: {
